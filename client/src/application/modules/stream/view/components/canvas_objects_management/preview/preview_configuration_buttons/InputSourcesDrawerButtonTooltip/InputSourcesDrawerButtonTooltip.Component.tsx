...
import {IInputSourcesDrawerContentExternalProps, InputSourcesDrawerContent} from "../InputSourcesDrawerContent/index";
...
@Consume<ISourceContext, IInputSourcesDrawerButtonTooltipProps>(sourceContextManager)
