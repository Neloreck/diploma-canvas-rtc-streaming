...
export interface ICanvasObjectsAdditionListExternalProps extends WithStyles<typeof canvasObjectsAdditionListStyle>, IGraphicsContextState {}
...
@Consume<IGraphicsContextState, ICanvasObjectsAdditionListProps>(graphicsContext)
@Styled(canvasObjectsAdditionListStyle)
export class CanvasObjectsAdditionList extends PureComponent<ICanvasObjectsAdditionListProps> {
