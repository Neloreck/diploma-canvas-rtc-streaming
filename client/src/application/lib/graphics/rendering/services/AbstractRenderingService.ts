...
import {CanvasGraphicsMovableObject} from "../graphics_objects/base/CanvasGraphicsMovableObject";
...
export abstract class AbstractRenderingService {
  ...
  public abstract setSelectedObject(object: CanvasGraphicsMovableObject | null): void;
